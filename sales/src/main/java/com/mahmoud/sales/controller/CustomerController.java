...
public class CustomerController {
    ...
    private void setupTable() {
        ...
        remainingBalanceColumn.setCellValueFactory(cd -> {
            ...
            // Customer rule: totalBalance = (trans - pay) - openBalance
            return new SimpleObjectProperty<>(baseRemaining.subtract(open));
        });
    ...
    private void updateTotalsUI(PersonService.Totals totals) {
        ...
        // Customer total balance rule: total = sumRemaining - sumOpen
